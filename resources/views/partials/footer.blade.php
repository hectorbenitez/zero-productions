<footer class="bg-black border-t border-white/10 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <!-- Quick Links -->
            <div>
                <h4 class="text-sm font-semibold uppercase tracking-wider text-gray-300 mb-4">Enlaces</h4>
                <ul class="space-y-2">
                    <li><a href="{{ route('home') }}" class="text-gray-400 hover:text-white text-sm transition-colors">Inicio</a></li>
                    <li><a href="{{ route('events.index') }}" class="text-gray-400 hover:text-white text-sm transition-colors">Eventos</a></li>
                    <li><a href="{{ route('contact.show') }}" class="text-gray-400 hover:text-white text-sm transition-colors">Contacto</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                @if($settings->hasSocialLinks() || $settings->hasWhatsapp())
        ...
        <div class="mt-8 pt-8 border-t border-white/10 text-center">
            <p class="text-gray-500 text-sm">
                &copy; {{ date('Y') }} {{ $settings->company_name ?? 'Zero Productions' }}. Todos los derechos reservados.
            </p>
        </div>
    </div>
</footer>
